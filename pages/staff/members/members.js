document.addEventListener('DOMContentLoaded', function () {
    ...
    window.minimizeCell = minimizeCell;
    window.openExitConfirmation = openExitConfirmation;
    window.closeExitConfirmation = closeExitConfirmation;
    window.confirmExit = confirmExit;
    window.filterWhosIn = filterWhosIn;
    window.resetScanResult = resetScanResult;
    window.simulateScanSuccess = simulateScanSuccess;
    window.simulateScanExpired = simulateScanExpired;
    window.simulateScanFail = simulateScanFail;
    window.allowEntry = allowEntry;
    window.selectPlan = selectPlan;
    window.confirmActivation = confirmActivation;
    window.setNmState = setNmState;
    window.showNewMemberChoice = showNewMemberChoice;
    window.showDailyPassForm = showDailyPassForm;
    window.showMembershipForm = showMembershipForm;
    window.applyDailyPass = applyDailyPass;
    window.selectMemberPlan = selectMemberPlan;
